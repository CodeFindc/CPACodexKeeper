...
from src.settings import SettingsError, load_settings, load_status_settings
...
class SettingsTests(unittest.TestCase):
    ...
    def test_load_status_settings_reads_status_snapshot_server_values(self):
        ...
        with patch.dict(
            ...
            settings = load_status_settings(env_file=env_file)
